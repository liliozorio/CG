...
// CREATE CHAMBERS
export function createChambers(size_plane, size_obstacle, size_tile, available_space, scene, bbcube, cubeS, blockElevationValue, invisibleWayBlocks) {
    const pp = {
    ...
    randomCube(auxCdnt.p1, 6, size_obstacle, available_space, bbcube, cubeS, scene)
    randomCube(auxCdnt.p2, 6, size_obstacle, available_space, bbcube, cubeS, scene)

    makeEdges({ x: auxCdnt.p0.x1, y: 0.75, z: auxCdnt.p0.z1 }, pp.p0.w - 1, pp.p0.h - 1, 3, { f1: 1, f2: 1, f3: 1, f4: 1 },bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p1.x1, y: -2.25, z: auxCdnt.p1.z1 }, pp.p1.w, pp.p1.h, 3, { f1: 1, f2: 1, f3: 0, f4: 0 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p2.x1, y: 3.75, z: auxCdnt.p2.z1 }, pp.p2.w, pp.p2.h, 3, { f1: 1, f2: 1, f3: 0, f4: 0 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p3.x1, y: -2.25, z: auxCdnt.p3.z1 }, pp.p3.w, pp.p3.h, 3, { f1: 0, f2: 0, f3: 1, f4: 1 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p4.x1, y: 3.75, z: auxCdnt.p4.z1 }, pp.p4.w, pp.p4.h, 3, { f1: 0, f2: 0, f3: 0, f4: 1 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p5.x1, y: -2.25, z: auxCdnt.p5.z1 }, pp.p5.w, pp.p5.h, 3, { f1: 0, f2: 1, f3: 0, f4: 0 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p6.x1, y: 3.75, z: auxCdnt.p6.z1 }, pp.p6.w, pp.p6.h, 3, { f1: -1, f2: 0, f3: 0, f4: 0 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p7.x1, y: -2.25, z: auxCdnt.p7.z1 }, pp.p7.w, pp.p7.h, 3, { f1: 0, f2: 0, f3: -1, f4: 0 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p8.x1, y: -2.25, z: auxCdnt.p8.z1 }, pp.p8.w, pp.p8.h, 3, { f1: -1, f2: -1, f3: 0, f4: 0 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p9.x1, y: 3.75, z: auxCdnt.p9.z1 }, pp.p9.w, pp.p9.h, 3, { f1: -1, f2: -1, f3: 0, f4: 0 },bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p10.x1, y: -2.25, z: auxCdnt.p10.z1 }, pp.p10.w, pp.p10.h, 3, { f1: 0, f2: 0, f3: -1, f4: -1 }, bbcube, cubeS, scene)
    makeEdges({ x: auxCdnt.p11.x1 + 1.5, y: 3.75, z: auxCdnt.p11.z1 }, pp.p11.w, pp.p11.h, 3, { f1: 0, f2: 0, f3: -1, f4: -1 }, bbcube, cubeS, scene)
...
export function cubesArea3(bbcube, platforms, scene, objectsArea3, cubeS) 
{
    let positionCubes = {
